...
function MovieForm(props)
{
    ...
    },[props.nameValue,props.lengthValue,props.genreValue,props.imageValue,props.bannerValue,props.ratingValue,props.summaryValue,props.trailerValue]);
    ...
    return(
        <div style={{maxWidth:"40%",margin:"0px auto"}}>
            ...
            <textarea defaultValue={props.summaryValue} onChange={(event)=>setSummary(event.target.value)} class="form-control my-3" placeholder="Enter movie Summary" />
            <input defaultValue={props.trailerValue} onChange={(event)=>setTrailer(event.target.value)} class="form-control my-3" placeholder="Enter movie trailer url" />
